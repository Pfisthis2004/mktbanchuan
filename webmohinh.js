...
function openModal(img, title, description, price, size, scale, material, technology, printTime, finishing, application) {
    var modal = document.getElementById("myModal");
    var modalImg = document.getElementById("img01");
    ...
    var productScale = document.getElementById("productScale");
    var productMaterial = document.getElementById("productMaterial");
    var productTechnology = document.getElementById("productTechnology");
    var productPrintTime = document.getElementById("productPrintTime");
    var productFinishing = document.getElementById("productFinishing");
    var productApplication = document.getElementById("productApplication");
    ...
    productScale.innerHTML = scale;
    productMaterial.innerHTML = material;
    productTechnology.innerHTML = technology;
    productPrintTime.innerHTML = printTime;
    productFinishing.innerHTML = finishing;
    productApplication.innerHTML = application;
}
